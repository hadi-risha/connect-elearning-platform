import instructor from '../../assets/userImages/instructor.png';
                        ...
                        <div className='ml-44 bg-white w-3/12 h-[595px] flex flex-col justify-center items-center border-2 border-gray-300'>
                            ...
                            <div className='p-5 bg-white w-full h-1/2 rounded-bl-md rounded-br-md'>
                                ...
                                <div className='flex mt-3 space-x-2 '>
                                    ...
                                    <p className='text-black text-md font-medium font-serif'>Cancelled</p>
                                </div>
                                ...
                                <div className='flex mt-3 space-x-2 '>
                                    <p className='text-black text-base font-normal'>Payment Status: </p>
                                    <p className='text-black text-md font-medium font-serif'>
                                        Refunded
                                    </p>
                                </div>
...
export default CancelledSessionInfo;
