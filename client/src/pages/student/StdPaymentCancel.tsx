...
import { SystemUiconsCrossCircle } from '../../assets/userIcons/SessionIcons';
    ...
    <>
      <div className="w-screen h-screen bg-white flex justify-center items-center -mt-11">
        <div className="px-16 py-20 rounded-2xl text-center space-y-3 shadow-lg">
          <div className='flex space-x-3'><SystemUiconsCrossCircle className='ml-28' />
          <h1 className="text-black font-bold text-md">Payment Failed!</h1></div>
