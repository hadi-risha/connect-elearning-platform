...
import UserBadgeItem from "../../components/user/ChatUserBadgeItem";
import UserListItem from "../../components/user/ChatUserListItem";
...
const GroupChatModal: React.FC<GroupChatModalProps> = ({ children }) => {
  ...
  const handleSearch = async (query: string) => {
    ...
    try {
      ...
      // console.log("response in group chat modal :-", response.data.users);
      setLoading(false);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // console.log("response in full group chat :- ", response.data.fullGroupChat);
      ...
      <Modal onClose={onClose} isOpen={isOpen} isCentered>
        ...
        <ModalContent>
          ...
          <ModalBody display="flex" flexDir="column" alignItems="center">
            ...
            <FormControl>
              <Input
                placeholder="Type Users name eg: John, Sara, Jane"
                mb={1}
